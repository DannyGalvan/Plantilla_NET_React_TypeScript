...
namespace Project.Server.Validations.Rol
{
    /// <summary>
    /// Defines the <see cref="UpdateRolValidation" />
    /// </summary>
    public class UpdateRolValidation : UpdateValidator<RolRequest, long?>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateRolValidation"/> class.
        /// </summary>
        public UpdateRolValidation()
        {
            RuleFor(x => x.Name)
